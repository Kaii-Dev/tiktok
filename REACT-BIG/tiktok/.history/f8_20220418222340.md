...
-- cách hoạt động : memo sẽ check props của compo nó wrap, mỗi compo có nhiều props, sau mỗi lần re-render có bị thay đổi gía trị hay ko? nếu có thay đổi thì re-render còn ko thì ko được re-render