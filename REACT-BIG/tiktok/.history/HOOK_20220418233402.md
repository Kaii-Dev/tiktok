...
ví dụ tham chiếu:
 ...
 -->
- *khi đã xác định XÀI REACT.MEMO ĐỂ TRÁNH COMPONENT CON BỊ RE-RENDER KHÔNG CẦN THIẾT THÌ NHỮNG FUNCTION PHẢI SỬ DỤNG USECALLBACK ĐỂ FUNCTION ĐÓ KHÔNG BỊ RE-RENDER KHÔNG CẦN THIẾT*
# cách hoạt động : giúp chúng ta ghi nhớ 1 fucntion mà ko tạo lại 1 function mới => hàm được truyền vào useCall
