...
-- cách hoạt động : memo sẽ check props của compo nó wrap, mỗi compo có nhiều props, chỉ cần 1 props thay đổi sau mỗi lần re-render có bị thay đổi gía trị hay ko? nếu có thay đổi thì re-render còn ko thì ko được re-render