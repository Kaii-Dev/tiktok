...
- cách sử dụng : đặt biết abc = createContext() => nó sẽ trả về obj gồm provider và consumer, dùng thẻ <abc.Provider value={xyz}></abc.Provider> để bao cả thằng cha lại
- gồm 3 bước :
  ++ 1. create context
