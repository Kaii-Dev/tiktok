...
function App() {
  ...
  return (
    <div style={{ padding: "80px 25px" }}>
      {/* vì thằng component Memo là thằng con của compo App nên sẽ bị re-render theo, vì vậy sử dụng phương thức memo bên file Memo.js để nó theo dõi props của Memo có bị thay đổi giá trị sau mỗi lần re-render không? nếu có mới cho  */}
      <Memo></Memo>
      <h1>{count}</h1>
