...
function App() {
  ...
  return (
    <div style={{ padding: "80px 25px" }}>
      {/* vì thằng component Memo là thằng con của compo App nên sẽ bị re-render theo, vì vậy sử dụng phương thức memo bên file Memo.js để nó theo dõi props của Memo có   */}
      <Memo></Memo>
      <h1>{count}</h1>
