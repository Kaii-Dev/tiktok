...
function Content() {
  ...
  useEffect(() => {
    //clean up
    return () => {
      ava && URL.revokeObjectURL(ava.preview); //nếu có preview thì revokeObjectURL, nếu thếu ava && thì sẽ hiện lỗi cant read bởi vì lúc đầu đang set state cho nó là undefined nên ko thể revoke
    };
  }, [ava]);
  return (
    <div className="">
