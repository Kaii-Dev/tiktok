...
function Content() {
  ...
  useEffect(() => {
    ...
    //thằng return này là clean up function nó sẽ được gọi trước khi component unmount => khi bấm toggle lần nữa để tắt thì hàm này sẽ gọi và nó sẽ clearinterval, và component mới bị unmount => hàm ko
    return () => {
