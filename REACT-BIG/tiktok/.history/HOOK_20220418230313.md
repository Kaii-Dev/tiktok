...
- custom props bằng cách sử dụng cú pháp "on + 'hành động gì đó'"
- một compo có thể có nhiều props, có thể props đó là những liệu nguyên thủy, cũng có thể là dữ liệu tham chiếu, có thể là hàm, hoặc obj hoặc array. khi đã xác định XÀI REACT.MEMO ĐỂ TRÁNH COMPONENT CON BỊ RE-RENDER KHÔNG CẦN THIẾT