...
-- trong call back của useeffect return ra 1 hàm và hàm đó là clean up function dùng để clean up bộ nhớ và nó sẽ gọi trước khi component đó bị unmounted
...
-- Khi làm việc với react component mà phát hiện được componet có thể bị unmount bằng bất cứ hành động nào mà trong compo đó có sử dụng timer, async  
