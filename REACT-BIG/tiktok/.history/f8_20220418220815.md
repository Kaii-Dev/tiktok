...
# PHƯƠNG THỨC MEMO (MEMORY)

*__ TRONG REACT CÓ 3 PHƯƠNG THỨC HAY ĐƯỢC SỬ DỤNG: Hooks(dùng bên trong fnc compo), HOC(high order component- sẽ wrap lạ), render props - 3 thằng này dùng để kế thừa lại logic*
